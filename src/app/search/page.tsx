  ...
  return (
    <>
      {results.length ? (
        ...
        <div className="flex flex-row items-center w-screen h-screen">
          <div className="flex flex-col w-full items-center">
            <div className="font-google text-[50px] text-gray-600">
              <span className="text-[57px] text-gray-800"> ☊ </span>
              <span className=" text-gray-800"> Latent.</span>
              <span>search</span>
            </div>
            <div className="font-google italic text-sm -mt-4 mb-6 text-gray-400">
              <span>Hallucinating the latent web since 2022</span>
            </div>
      ...
      <ModelProgressBar
        ...
        isLoading={isLoading}
        model={settings.openAIModel || 'gpt-3.5-turbo-instruct'}
        provider="OpenAI"
