...
- "ui.p": Once upon a time, there was a carpenter who wanted to build a dog out of wood. He worked tirelessly, day and night, until finally his creation came to life.
- "ui.h2": The Creation
- "ui.p": He crafted the dog down to the finest details, from the way it moved to the way it barked. It was a truly remarkable sight to behold.
- "ui.h2": The Journey
...
- "ui.p": They had many exciting adventures together, facing danger and finding friendship. It was a journey that neither of them would ever forget.
- "ui.h2": The End
- "ui.p": After a long and eventful journey, the carpenter and his dog eventually returned home. The carpenter had gained a new appreciation for life, and the dog had found a new home.
- "fiber.scene":
  - "fiber.ball"
  - "fiber.ball"
  - "fiber.ball"
...
- "ui.p": >
    "My sweetheart, let me love you so
